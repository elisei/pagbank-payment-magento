...
/**
 * Plugin for preparing PagBank DeepLink payment data
 */
class SetDeepLinkPaymentData
{
    /**
    ...
    public function afterExecute(
        ...
        if ($paymentData['code'] !== ConfigProviderDeepLink::CODE) {
            return $result;
        }
        ...
        try {
            ...
            $inputData = $paymentData[ConfigProviderDeepLink::CODE] ?? [];
            ...
            throw new GraphQlInputException(__('Error processing DeepLink payment information: %1', $e->getMessage()));
        }
